...
class GMM:
    ...
    def run(self):
        ...
        log_likelihoods = [] # In this list w   ore the log likehoods per iteration and plot them in the end to check if
        ...
        for i in range(self.iterations):               
            ...
            self.pi = []
            log_likelihood = []
            print('ric shape', r_ic.shape)
            print('X shape', self.X.shape)
            print('reg cov shape', self.reg_cov.shape)
            print('ric', r_ic)
            print('X', self.X)
            print('reg cov', self.reg_cov)
